...
const MidBanner = () => {
  return (
    <div className='bg-gray-100 mt-20'>
      <div className='relative max-w-7xl mx-auto bg-cover bg-center h-[450px] md:h-[500px] lg:h-[550px]' style={{backgroundImage: `url(${banner})`, backgroundPosition:'center', backgroundAttachment:'fixed'}}>
